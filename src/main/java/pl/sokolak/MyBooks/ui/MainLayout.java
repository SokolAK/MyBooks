...
public class MainLayout extends AppLayout {
    ...
    private void createDrawer() {
        ...
        routerLinks.add(new RouterLink(TextFormatter.header("MainLayout.books"), BooksListView.class));
        routerLinks.add(new RouterLink(TextFormatter.header("MainLayout.authors"), AuthorsListView.class));
        routerLinks.add(new RouterLink(TextFormatter.header("MainLayout.publishers"), PublishersListView.class));
        routerLinks.add(new RouterLink(TextFormatter.header("MainLayout.series"), SeriesListView.class));
